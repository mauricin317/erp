...
export default function FormDetalleNotaVenta(props) {
  ...
  if (props.tipo == "editar") {
    ...
    let articulo1 = _.find(props.articulos, [
      "idarticulo",
      props.datos.idarticulo,
    ]);
  ...
  const [articulo, setArticulo] = useState(
    edit_detalle == null ? null : props.articulos[pos]
  );
        ...
        <Grid container spacing={2}>
          ...
          <Grid item md={2} xs={12}>
            <Autocomplete
              ...
              renderInput={(params) => (
                <TextField
                  error={Boolean(
                    formik.touched.cantidad && formik.errors.nrolote
                  )}
                  fullWidth
          ...
          <Grid item md={2} xs={12}>
            <TextField
              ...
              type="number"
              value={Number(
                formik.values.cantidad * formik.values.precioventa
              ).toFixed(2)}
              variant="outlined"
              disabled
              inputProps={{
